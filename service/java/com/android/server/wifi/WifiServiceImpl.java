...
public class WifiServiceImpl extends BaseWifiService {
    ...
    // Must match LineageSettings.Global.WIFI_OFF_TIMEOUT
    ...
    public void handleBootCompleted() {
        mWifiThreadRunner.post(() -> {
            ...
            mContext.getContentResolver().registerContentObserver(
                    LineageSettings.Global.getUriFor(WIFI_OFF_TIMEOUT),
                    false,
    ...
    private void setWifiTimeout() {
        long wifiTimeoutMillis = LineageSettings.Global.getLong(mContext.getContentResolver(),
                WIFI_OFF_TIMEOUT, 0);
