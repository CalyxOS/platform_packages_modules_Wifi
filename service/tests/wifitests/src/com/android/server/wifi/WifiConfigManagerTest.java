...
public class WifiConfigManagerTest extends WifiBaseTest {
    ...
    /**
     * Verify that when non-persistent MAC randomization is enabled the MAC address changes after the
     * maximum refresh time has elapsed since the first connection this MAC address is used.
     */
    @Test
